...
<p align="center">
  <img src="docs/screenshots/editor-hero.png" alt="ScreenForge annotation editor" width="820" />
</p>
...
<p align="center">
  <img src="docs/screenshots/menu-bar.png" alt="Menu bar capture menu" width="400" />
  &nbsp;
  <img src="docs/screenshots/settings-general.png" alt="Settings" width="400" />
</p>

<p align="center">
  <img src="docs/screenshots/history-list.png" alt="Capture history" width="820" />
</p>
...
- Grant **Screen Recording** via **Request permission** in onboarding (system sheet). Do not rely on the Settings “+” button.
- Releases are **ad-hoc signed** (same pattern as earlier working builds). After an update, you may need to Request permission once more.
